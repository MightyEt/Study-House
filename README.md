...
# STEP ONE: Retrieve unverified recognised prior learning (RPL) as per the South-African Qualifications Authority (FUNCTION)
...
# STEP FOUR: Provide information pertaining to measures needed to be undertaken to retrieve Verfified RPL (EVENT?)
EXAMPLE: Qualifications Verifications Service (QVS) - COST
# STEP FIVE: Provide information on level of education as per the National Qualifications Framework (NQF), which department to communicate with, and in which direction to head based on location and open educational resources (FUNCTION)
