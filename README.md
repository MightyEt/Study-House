...
# STEP FIVE: Provide information on level of education as per the National Qualifications Framework (NQF), which department to communicate with, and in which direction to head based on location (FUNCTION)
